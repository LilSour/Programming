...
### 2.1-12
![Скриншоты](images/5.2.1.jpg)
- Создание файла mergesort.py и добавление кода, коммит его

![Скриншоты](images/5.2.2.jpg)
-Создание ветки Mergesort-Impl и перемещение на неё

![Скриншоты](images/5.2.3.jpg)
- Замена кода в mergesort.py и его коммит

![Скриншоты](images/5.2.4.jpg)
- Перемещение на ветку main и замена кода в margesort.py, его коммит

![Скриншоты](images/5.2.5.jpg)
- git log --online --graph показывает новые коммиты ветки main

![Скриншоты](images/5.2.6.jpg)
- git branch показывает все ветки и в какой нахожусь

![Скриншоты](images/5.2.7.jpg)
- merge conflict который исправил, приняв входящие изменения во всех строках